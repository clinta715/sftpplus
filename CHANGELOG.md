...
- **New Site Connection Bug**: Fixed connection failure for newly created sites. Was using placeholder hostname (e.g., "new_site_1") from UserRole instead of the actual hostname user typed in form field.
